...
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 5.1 slides](../slides/week5.1-typography-slides.qmd){.btn role="button" target="_blank"} 
:::
:::
...
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 5.3 slides](../slides/tbd.qmd){.btn role="button" target="_blank"} 
:::
:::
