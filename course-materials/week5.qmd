...
-- I'll be using tGoogle Chrome extension in class. It's a really wonderful and easy-to-use tool if you typically use the Google Chrome web browser. I recommend installing it!
