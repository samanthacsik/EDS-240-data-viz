...
Week 5 instruction is broken down into two lessons:
...
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 4.3 slides](../slides/week5.1-good-viz-slides.qmd){.btn role="button" target="_blank"} 
:::
:::
...
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 5.1 slides](../slides/week5.2-colors-slides.qmd){.btn role="button" target="_blank"} 
:::
:::
