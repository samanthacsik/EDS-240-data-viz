...
Data viz designer and instructor, [Amy Cesal](https://www.amycesal.com/), suggests this rule of thumb for writing alt text for data visualizations: **alt=“[Chart type]{style="background-color:#F9C9C8"} of [type of data]{style="background-color:#FDC790"} where [reason for including chart]{style="background-color:#D1EAEE"}**.
...
[**alt="[Colored stripes]{style="background-color:#F9C9C8"} of [chronologically ordered temperatures]{style="background-color:#FDC790"} where [they increase in red to show the warming global temperature]{style="background-color:#D1EAEE"}"**]{.body-text-s}
...
- **link to the data or source** (not in your alt text, but somewhere in the surrounding text)
:::
...
1. Add the `fig-alt` code chunk option when rendering ggplot (or other data visualization) code within a `.qmd` file:
