...
install.packages("ggforce") # does lots of awesome stuff; includes `geom_mark_ellipse()` & `facet_zoom()`
...
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 6.2 slides](../slides/week6.2-annotations-slides.qmd){.btn role="button" target="_blank"}
:::
:::
