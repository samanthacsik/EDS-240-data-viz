...
::: {.g-col-12 .g-col-md-4}
::: {.center-text}
[**Choosing chart types (I)**]{.teal-text .body-text-m}

[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} lecture 3.1 slides](../slides/week3.x-tbd-slides.qmd){.btn role="button" target="_blank"} 
:::
:::

::: {.g-col-12 .g-col-md-4}
::: {.center-text}
[**Choosing chart types (II)**]{.teal-text .body-text-m}
...
::: {.g-col-12 .g-col-md-4}
::: {.center-text}
[**Exploratory Data Viz**]{.teal-text .body-text-m}
