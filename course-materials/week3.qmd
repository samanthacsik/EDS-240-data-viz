...
[**This week, we'll focus on data layer, geometric layer, and scales. Next week, we'll work on tweaking the theme (all non-data elements) to get it to look just like the U.S. Drought Monitor's version.**]{.teal-text}
