...
- [County-level Lyme disease data from 2001-2020](https://www.cdc.gov/lyme/resources/datasurveillance/LD-Case-Counts-by-County-01-20.csv){target="_blank"}, made available by the CDC (read more on [this CDC web page](https://www.cdc.gov/lyme/stats/survfaq.html){target="_blank})
  - save the downloaded data (`LD-Case-Counts-by-County-01-20.csv`) to your class repo at the file path: `EDS-240-class-examples/week2/data/LD-Case-Counts-by-County-01-20.csv`
...
### C. Download today's `.qmd` template & review initial data wragling code
