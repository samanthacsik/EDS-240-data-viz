...
[In this lesson, we'll be exploring two primary chart types:]{.gray-text}
...
[Using the publicly-available CDC data on Lyme disease and population estimates from the [US Census Bureau](https://www.census.gov/) (via the [`{tidycensus}` package]()), we'll explore **changes in Lyme disease incidence (cases/100k people) over time**, by state.]{.body-text-s}
...
::: footer
Example from [Meghan Hall](https://meghan.rbind.io/)'s [Statistical Graphics & Visualization](https://cmu-36315.netlify.app/) course [Lecture 5 slides](https://cmu-36315.netlify.app/slides/36-315_summer2021_lec5#1).
:::
...
<!-- - 2 parts: -->
<!--   - choosing the right graphic form (SBC LTER data) -->
<!--   - data wrangling & exploratory data viz using your own data (HW #4) -->
