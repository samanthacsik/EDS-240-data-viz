...
- [ ] **1.** Which of the [two options](HW4.qmd#hw4-options){target="_blank"} are you most interested in pursuing? It's okay if you change your mind later on, but it's helpful to decide on a starting point. 
