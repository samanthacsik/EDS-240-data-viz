...
In this assignment, you’ll reflect on your learning throughout this class. Revisit your self-reflections from the start and middle of the quarter, and answer the following questions in [**2-6 sentences**]{.peach-text} each:

- [ ] Since your mid-quarter self-reflection, have you improved any of your existing skills? Have you learned new ones?
- [ ] Have you accomplished your learning goals for this quarter (that you set in SR #1, and potentially expanded upon / modified in SR #2)? If you did, how did you do it?
...
- [ ] include your preferred name, and if you feel comfortable,your preferred pronouns in the `author` field of the `SR3-endcourse-reflection.qmd` YAML 
...
Additionally, please complete the formal UCSB course evaluations for both the EDS 240 instructor (Sam Csik) and TA (Sevan Esaian) by the deadline (Friday, 03/15/2024).
