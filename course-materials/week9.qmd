...
Tinker or fork (if you have an account) Allison's notebook, [EDS 240: Data visualization in JavaScript (Follow-along version)](https://observablehq.com/@observablehq/eds-240-javascript-data-viz-follow).
