...
jobs_clean <- jobs |> 
  ...
  # ---- this next steps are necessary for creating our dumbbell plots ----
...
::: {.footer .center-text}
[For some more advanced label manipulation, see [A Quick How-to on Labelling Bar Graphs in ggplot2](https://www.cedricscherer.com/2021/07/05/a-quick-how-to-on-labelling-bar-graphs-in-ggplot2/), by Cédric Scherer]{.body-text-s}
:::
