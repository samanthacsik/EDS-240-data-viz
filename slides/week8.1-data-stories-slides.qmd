...
## {#warming-stripes1 data-menu-title="Consider audience (Ex. 1)"} 
...
## {#iucn data-menu-title="Consider audience (Ex. 2)"} 
...
## {#glimmers data-menu-title="Consider audience (Ex. 3)"} 
...
::: {.footer}
Fig. 3, by [Ingeman et al. 2022](https://www.nature.com/articles/s41598-022-13671-7): Glimmers of hope and critical cases.
:::
...
## {#plants data-menu-title="Consider audience (Ex. 4)"} 

[Consider the audience (Ex. 4)]{.slide-title}
