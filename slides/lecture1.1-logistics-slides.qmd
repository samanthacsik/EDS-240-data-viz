...
| 1/22    | data communication                           |
| 1/29    | graphic design                               |
| 2/5     | visualizing amounts & proportions            |
| 2/12    | visualizing relationships & distributions    |
| 2/19    | [*no class* ]{.teal-text}                    |
| 2/26    | visualizing uncertainty                      |
...
You *do not* need to provide a reason to request an extension, revision, or to miss class, but *you must* have enough tokens to do so.
