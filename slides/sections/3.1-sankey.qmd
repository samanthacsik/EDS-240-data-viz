...
# pop_test <- pop2022_no_other |> 
#   select(coo_name, coa_name, refugees)
...
#| echo: false
# df <- pop_test |> 
# df<-  make_long(coo_name, coa_name, refugees)
# 
# ggplot(df, aes(x = x,
#                next_x = next_x,
#                node = node,
...
#   geom_sankey()
# 
# ggplot(pop2022_no_other, aes(x = refugees, next_x = coa_name,
#                node = coo_name, next_node = coa_name, #fill = factor(refugees)
#                )) +
#   geom_sankey() +
