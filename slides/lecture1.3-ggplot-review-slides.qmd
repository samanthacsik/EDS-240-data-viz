...
We'll start by exploring the relationship between penguin **flipper length** and **body mass**.

---

## {#initialize data-menu-title="Initialize plot"} 

[Initialize a plot object]{.slide-title}
...
::: footer
[**1. data**]{.teal-text} | 2. geometric object | 3. statistical transformation | 4. position adjustment | 5. coordinate system | 6. facet 
:::
...
[Initialize a plot object + map aesthetics]{.slide-title}
...
[NOTE: Omitting argument names]{.slide-title}
...
[Define a geom to represent data]{.slide-title}
...
::: footer
1. data | [**2. geometric object**]{.teal-text} | 3. statistical transformation | 4. position adjustment | 5. coordinate system | 6. facet 
:::
...
[NOTE: Defining data & mappings in `geom_*()`]{.slide-title2}
...
::: footer
1. data | 2. geometric object | [**3. statistical transformation**]{.teal-text} | 4. position adjustment | 5. coordinate system | 6. facet 
:::
