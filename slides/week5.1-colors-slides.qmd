...
::: {.center-text}
One of the most important decisions you'll need to make is **what type of color scale** to use (and of course, what colors).
:::
...
Lucky for us, **RColorBrewer** has this exact palette:
...
Add palette colors & adjust colorbar appearance
...
#| fig-align: "center"
base_map_proj + 
  scale_fill_gradientn(colors = my_brew_palette,
...
custom_guide <- function(type) {
  ...
  # if bin, use guide_colorsteps() ----
    ...
    guides(fill = guide_colorsteps(title = "% change",
                                   title.position = "top",
                                   barwidth = 15, barheight = 0.75))
  }
}
...
#| fig-align: "center"
base_map_proj + 
  scale_fill_stepsn(colors = my_brew_palette) +
  custom_guide(type = "b")
```
:::
