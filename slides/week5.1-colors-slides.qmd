...
[Different palettes types for different data types]{.slide-title2}
...
<!-- 2. **Quantitative (for continuous numeric data)** -->
...
<!-- [Palette Types]{.slide-title} -->

<!-- <hr> -->

<!-- 1. **Qualitative (for categorical / discrete data)** -->

<!--     - [colors assigned to each group must be distinct and ideally have different lightnesses (so that they also work in grayscale)]{.body-text-s} -->
...
#....................import precipitation data...................
precip_counties <- read_csv(here::here("week5", "data", "county-precip-oct2023.csv"), skip = 4) |> 
  janitor::clean_names()
