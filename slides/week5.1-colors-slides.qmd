...
- [steal colors from your favorite / relevant images using [Color Theif](https://lokeshdhakar.com/projects/color-thief/)]{.body-text-s}
...
[Some common functions for mapping colors]{.slide-title2}
...
[Here, we map our colors to a categorical variable (sex) using `scale_color_manual()`:]{.body-text-s}
