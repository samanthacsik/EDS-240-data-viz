...
<hr>
  ...
  - [can use a single hue (light to dark) *or* two hues (typically a warmer / brighter hue for lower values and cooler / darker hue for higher values...but not always)]{.body-text-s}
