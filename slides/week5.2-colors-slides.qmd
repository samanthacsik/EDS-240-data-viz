...
::: {.footer}
You may notice that Connecticut is missing most of it's data. After some digging, I learned that CT recently (2022) replaced it's eight counties with nine planning regions as county-equivalents (read more in the [UC Census Bureau Notice on 06/06/2022](https://www.federalregister.gov/documents/2022/06/06/2022-12063/change-to-county-equivalents-in-the-state-of-connecticut)). I couldn't quite make sense of how to match old county names to new planning regions, as there's a decent amount of [overlap](https://en.wikipedia.org/wiki/List_of_counties_in_Connecticut#/media/File:CT_Planning_vs_County_Census.png), soooo I gave up (for now) {{< fa face-grin-beam-sweat title="grinning face with sweat dripping from forehead" >}}. 
:::
