...
::: {.center-text}
[A recreation of Cleveland & McGill's hierarchy of elementary perceptual tasks, by Albert Cairo]{.gray-text}
:::
...
## {#caveats1.1 data-menu-title="Caveats 1.1"} 
...
- unemployment rates by state or county?
```{r}
#| eval: true
#| echo: false
#| fig-align: "center"
...
## {#caveats2.1 data-menu-title="Caveats 2.1"} 
...
[Graphic recreated following [Louise E. Sinks'](https://lsinks.github.io/) blog post, [TidyTuesday: Exploring Refugee Flow with A Sankey Diagram](https://lsinks.github.io/posts/2023-08-28-TidyTuesday-Refugees/TidyTuesday34-refugees.html)]{.gray-text .body-text-s}
...
## {#tips1 data-menu-title="Tips for choosing a graph"} 
...
## {#dvc data-menu-title="Data Visualization Catalogue"} 

[1. Think about the task(s) you want to enable or message(s) you want to convey]{.slide-title3}
<!-- Choose chart types based on function -->
...
[search graphic forms by their function]{.body-text-s}
:::
...
## {#tips2 data-menu-title="Tips for choosing a graph"} 
...
## {#fdtv data-menu-title="From Data To Viz"} 

[2. Consider # of variables & data points, data types]{.slide-title}
...
[a decision tree for choosing graphic forms based on data type(s)]{.body-text-s}
:::
...
## {#tips3 data-menu-title="Tips for choosing a graph"} 
...
[Try different graphic forms]{.slide-title}

Recall choropleth from earlier. What if we want to compare unemployment rates between counties? Choosing a graphical form from the top of the scale (e.g. bar chart) may be most effective.

And if we want to show both big picture patterns and detailed comparisons, **consider including multiple graphic forms in the same visualization!**

---

## {#tips4 data-menu-title="Tips for choosing a graph"} 
...
advertising methods example from Cairo (or try to find EDS alternative)

---

## {#tips-choosing-graph5 data-menu-title="Tips for choosing a graph"} 
