...
Precipitation data downloaded from NOAA's [National Centers for Environmental Information](https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/county/mapping/110/pcp/202310/1/value). Map created using the [`{maps}` package](https://cran.r-project.org/web/packages/maps/index.html).
:::
...
NEED TO TROUBLESHOOT CODE (code runs but errors out when rendering on slide)
...
## {#tips1 data-menu-title="Tips for choosing a graph 1"} 
...
## {#tips2 data-menu-title="Tips for choosing a graph 2"} 
...
a. changes in the amount spent on Social Security over time (2012-2015) relative to other major spending categories?
...
3. Identify how to use more effective elementary perceptual tasks for the primary and secondary insights.
