...
2. [**Some questions about the way you like to learn:**]{.teal-text}   
    ...
    - [ ] What have you struggled with in the past in other graduate-level courses? Why?
...
3. [**Some fun questions:**]{.teal-text}  
    ...
    - [ ] What activity(ies) (outside of school / work) brings you the most joy? How do you plan to incorporate that activity into your schedule this quarter (if at all)? If you are unable to do so, is there something else you can plan to do that will bring you similar joy? 
