...
## Tip: Remember to check out the [Resources page](https://samanthacsik.github.io/EDS-240-data-viz/resources.html)!!
...
- [ ] Mock up your visualizations using code, as best you can. They **do not** have to be perfect and **it's okay** if you can't quite get things working just yet -- you will not be graded on having all your visualizations created with code this round, but getting as far as you can *now* means time to receive feedback from us and less stress during HW #4. 
...
- [ ] Complete all exercises and answer all questions under the [Description section](https://samanthacsik.github.io/EDS-240-data-viz/assignments/HW3.html#description) above (use the check boxes to ensure you've completed all required parts).

::: {.callout-note}
## A few notes on expectations

-  While mocking up your visualizations in R is *not required* for a "Satisfactory score", it is *highly* encouraged that you do so (or at least start to do so). This will provide you an opportunity to receive feedback from us ahead of HW #4.
...
- [ ] Code should be appropriately styled and annotated (please see [this resource](https://samanthacsik.github.io/EDS-240-data-viz/clean-code-guide.html) on the course website), and your `.qmd` file should be easy to navigate.
