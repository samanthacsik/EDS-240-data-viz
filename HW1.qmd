...
- [ ] **(representing step 4)** how you would improve plot clarity/the take home message(s) [**(1-2 sentences)**]{.peach-text}
- [ ] **(representing step 5)** some design choices you might make as you polish off your data visualization [**(1-2 sentences)**]{.peach-text}

**Note:** Steps 4 and 5, above, are thought exercises -- it's okay if you don't yet know exactly how to approach answering these (we'll be spending time during these first few weeks of class talking about data communication and design theory).
