...
- **[R for Data Science](https://r4ds.hadley.nz/), by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund** -- an excellent primer on all things R for programming, data wrangling, visualizing, and communicating
