...
### Typography
- **[Google Fonts](https://fonts.google.com/)** -- catalog of open-source fonts and icons, which can be imported for use with `{ggplot2}`
...
<!-- Week 1 -->
<!-- - **[`{palmerpenguins}`](https://allisonhorst.github.io/palmerpenguins/):** a dataset for data exploration & visualization, as an alternative to `iris` -->
...
<!-- - **[`{usdata}`](https://openintrostat.github.io/usdata/):** demographic data on the United States at the county and state levels spanning multiple years -->
<!-- Week 2 -->
...
<!-- - **[`{tidytuesdayR}`](https://thebioengineer.github.io/tidytuesdayR/):** used to download TidyTuesday data -->
<!-- - **[`{tidycensus}`](https://walker-data.com/tidycensus/):** an R package that allows users to interface with a select number of the US Census Bureau’s data APIs and return tidyverse-ready data frames, optionally with simple feature geometry included -->
